...
const episodeData = {
  ep1: {
    ...
    levels: [
      ...
      {
        targetWord: "paddle", statement: "Paddle in water", words: ["Paddle", "in", "water"], distractors: ["jump", "walk"], sentenceWithBlank: "_______ in water.", image: "assets/ep5_paddle.png",
        emoji: "🏞️"
      },
      {
        targetWord: "wind",
  ...
  ep8: {
    ...
    levels: [
      ...
      {
        targetWord: "chart",
        statement: "Read the eye chart",
        words: ["Read", "the", "eye", "chart"],
        distractors: ["book", "paper"],
        sentenceWithBlank: "Read the eye _______.",
        image: "assets/ep8_chart.png",
        emoji: "👁️"
      },
      {
        targetWord: "blur",
        statement: "Everything looks blurry",
        words: ["Everything", "looks", "blurry"],
        distractors: ["clear", "bright"],
        sentenceWithBlank: "Everything looks _______.",
        image: "assets/ep8_blur.png",
        emoji: "🔍"
      },
      {
        targetWord: "clear",
        statement: "Now it is clear",
        words: ["Now", "it", "is", "clear"],
        distractors: ["dark", "hidden"],
        sentenceWithBlank: "Now it is _______.",
        image: "assets/ep8_clear.png",
        emoji: "✨"
      },
      {
        targetWord: "yellow",
      ...
      },
      {
        ...
        image: "assets/ep8_sunglasses.png",
        emoji: "🕶️"
      },
      {
        targetWord: "funny",
  ...
  ep9: {
    ...
    levels: [
      ...
      },
      {
        ...
        image: "assets/ep9_broken.png",
        emoji: "🛠️"
      },
      {
        targetWord: "mechanic", statement: "Grandpa is mechanic", words: ["Grandpa", "is", "mechanic"], distractors: ["driver", "doctor"], sentenceWithBlank: "Grandpa is _______.", image: "assets/ep9_mechanic.png",
        emoji: "🛟"
      },
      {
        targetWord: "tow",
      ...
      {
        targetWord: "hose", statement: "Water from the hose", words: ["Water", "from", "the", "hose"], distractors: ["bucket", "cup"], sentenceWithBlank: "Water from the _______.", image: "assets/ep9_hose.png",
        emoji: "💧"
      },
      {
        targetWord: "switch",
